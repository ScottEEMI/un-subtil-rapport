...
setInterval(function(){
    containerPop.append("<div style='left: "+ft_rand(50)+"%;top:"+ft_rand(45)+"%;' class='border-pop'><div onclick='ft_remove(this.parentElement)' class='deletepop'>X</div><div class='background poporn-size poporn-"+ft_rand(6)+"'></div></div>");
}, timeR);
